...
#define TASKNAME "gcdfibonacci"
	...
	single.a[1][0] = 1;
	single.a[1][1] = 1;
	//cout << __gcd(expo_power(single, n).a[1][0], expo_power(single, m).a[1][0]) - (__gcd(expo_power(single, n).a[1][0], expo_power(single, m).a[1][0]) / mod) * mod;
	cout << __gcd(expo_power(single, n).a[1][0], expo_power(single, m).a[1][0]);
	return 0;
}
/*
INPUT
